...
export interface HomeData {
  ...
  transportOffers: {
    flights: TransportOffer[];
    trains: TransportOffer[];
  };
  rideHailingServices: RideHailingService[];
}
...
export const homeData: HomeData = {
  ...
  transportOffers: {
    flights: [
      // Cameroon (CM) - Yaoundé flights
      {
        id: 'flight-cm-yaounde-douala-1',
        type: 'plane',
        origin: 'Yaoundé',
        originCode: 'YDE',
        destination: 'Douala',
        ...
        isNonStop: true,
        airline: 'Camair-co',
        airlineLogo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Camair-Co_logo.svg/200px-Camair-Co_logo.svg.png',
        price: 50000,
        currency: 'xaf',
        passengersIncluded: 2,
        countryId: 'CM',
        cityId: 'yaounde',
        availableDates: ['10-11-2025', '11-11-2025', '12-11-2025', '13-11-2025', '14-11-2025'],
      },
      {
        id: 'flight-cm-yaounde-garoua-1',
        type: 'plane',
        origin: 'Yaoundé',
        originCode: 'YDE',
        destination: 'Garoua',
        ...
        countryId: 'CM',
        cityId: 'yaounde',
        availableDates: ['10-11-2025', '11-11-2025', '12-11-2025'],
      },
      {
        id: 'flight-cm-yaounde-maroua-1',
        type: 'plane',
        origin: 'Yaoundé',
        originCode: 'YDE',
        destination: 'Maroua',
        ...
        isNonStop: true,
        airline: 'Air India',
        airlineLogo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Air_India_Logo.svg/200px-Air_India_Logo.svg.png',
        price: 50000,
        currency: 'xaf',
        passengersIncluded: 2,
        countryId: 'CM',
      ...
      // France (FR) - Paris flights
      {
        id: 'flight-fr-paris-lyon-1',
        type: 'plane',
        origin: 'Paris',
        originCode: 'CDG',
        destination: 'Lyon',
      ...
      {
        id: 'flight-fr-paris-marseille-1',
        type: 'plane',
        origin: 'Paris',
        originCode: 'CDG',
      ...
      // United States (US) - New York flights
      {
        id: 'flight-us-ny-chicago-1',
        type: 'plane',
        origin: 'New York',
        originCode: 'JFK',
        destination: 'Chicago',
        ...
        airlineLogo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/American_Airlines_logo_2013.svg/200px-American_Airlines_logo_2013.svg.png',
        price: 350,
        currency: '$',
        passengersIncluded: 2,
        countryId: 'US',
      ...
      },
      {
        ...
        airlineLogo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/United_Airlines_logo_2011.svg/200px-United_Airlines_logo_2011.svg.png',
        price: 450,
        currency: '$',
        passengersIncluded: 2,
        countryId: 'US',
      ...
      // Canada (CA) - Quebec flights
      {
        id: 'flight-ca-quebec-ontario-1',
        type: 'plane',
        origin: 'Quebec',
        originCode: 'QBC',
        ...
        isNonStop: true,
        airline: 'IndiGo',
        airlineLogo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9b/IndiGo_Logo.svg/200px-IndiGo_Logo.svg.png',
        price: 450,
        currency: 'C$',
        passengersIncluded: 2,
        countryId: 'CA',
    ...
    trains: [
      // Cameroon (CM) - Yaoundé trains
      {
        id: 'train-cm-yaounde-douala-1',
        type: 'train',
        origin: 'Yaoundé',
        destination: 'Douala',
        departureTime: '06:20',
      ...
      // France (FR) - Paris trains
      {
        id: 'train-fr-paris-lyon-1',
        type: 'train',
        origin: 'Paris',
        destination: 'Lyon',
        departureTime: '12:20',
      ...
      // United States (US) - New York trains
      {
        id: 'train-us-ny-chicago-1',
        type: 'train',
        origin: 'New York',
        destination: 'Chicago',
        departureTime: '12:20',
      ...
      // Canada (CA) - Quebec trains
      {
        id: 'train-ca-quebec-ontario-1',
        type: 'train',
        origin: 'Quebec',
        destination: 'Ontario',
        departureTime: '12:20',
  ...
  rideHailingServices: [
    // Cameroon (CM)
    {
      ...
      provider: 'uber',
      name: 'Uber Comfort',
      coverage: 'Couverture : Toutes grandes ville',
      countryId: 'CM',
      cityId: 'yaounde',
      downloadUrl: 'https://www.uber.com/fr/fr/ride/',
      color: '#000000',
    },
    {
      id: 'ride-cm-yango',
      provider: 'yango',
      name: 'Yango Standard',
      coverage: 'Forte présence',
      countryId: 'CM',
      cityId: 'yaounde',
      downloadUrl: 'https://yango.com/',
      color: '#FFD700',
    },
    {
      id: 'ride-cm-bolt',
    ...
    },
    {
      ...
      countryId: 'FR',
      cityId: 'paris',
      downloadUrl: 'https://www.lyft.com/',
      color: '#FF00BF',
    },
    {
      id: 'ride-fr-bolt',
    ...
    // United States (US)
    {
      ...
      countryId: 'US',
      cityId: 'new-york',
      downloadUrl: 'https://www.uber.com/',
      color: '#000000',
    },
    {
      id: 'ride-us-lyft',
